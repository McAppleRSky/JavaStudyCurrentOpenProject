package edu.sgu.lab2.buffer.variant6;
...
public class Buffer extends CBuffer implements //NBufCount3, LSize80,
    ...
    private void sum() {
        result[0] = result[0] = Float.valueOf(0);
