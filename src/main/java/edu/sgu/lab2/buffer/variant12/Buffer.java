package edu.sgu.lab2.buffer.variant12;
...
public class Buffer extends CBuffer implements //NBufCount4, LSize70,
        IBufferComputable, IBufferComputSum, IBufferPrintable,
        IBufferSortable, IBufferSortSelect,
        IBufferStorable, IBufferStore2 {

    private Integer[] buffer, result = new Integer[2];
    ...
    private void sum() {
        result[0] = result[0] = Integer.valueOf(0);
